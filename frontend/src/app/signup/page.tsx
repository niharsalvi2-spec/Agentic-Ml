...
export default function SignupPage() {
  ...
  return (
    <div className="min-h-screen bg-background flex flex-col justify-center items-center relative overflow-hidden px-4 py-20">
      {/* Decorative Orbs */}
      <div className="absolute top-1/4 right-1/4 w-96 h-96 bg-primary/10 rounded-full blur-[100px] pointer-events-none" />
      <div className="absolute bottom-1/4 left-1/4 w-72 h-72 bg-secondary-foreground/10 rounded-full blur-[80px] pointer-events-none" />

      <div ref={containerRef} className="glass-panel p-10 md:p-12 rounded-[2rem] w-full max-w-md relative z-10">
        <div className="text-center mb-8">
          <h1 className="text-3xl font-light tracking-tight text-foreground mb-2">Create an Account</h1>
          <p className="text-secondary-foreground font-light text-sm">Start orchestrating your ML models</p>
        </div>
        ...
        <form onSubmit={handleEmailSignup} className="space-y-4">
          ...
          <div className="pt-2">
            <button 
              type="submit" 
              className="w-full flex items-center justify-center gap-2 bg-primary text-primary-foreground py-3.5 px-4 rounded-xl font-medium hover:bg-primary/90 hover:shadow-lg transition-all duration-300 group"
            >
              Create Account
